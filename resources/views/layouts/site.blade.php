...
<div class="container-fluid footer">
    <div class="container">
        ...
        <div class="row footer-info">
            ...
            <span class="info">Сервис помогает быть в курсе актуальной информации, чтобы начать игру в регламентированное время открытия.  Функции кросспостинга в социальные сети позволяет игрокам быть в курсе открытия новых серверов л2 в тех каналах информации, в которых игроки сёрфят интернет пространство. Удобные фильтры позволяют в считанные секунды найти нужный сервер л2 по хроникам и рейтам. Для владельцев серверов л2, у нас представлена привилегия на предмет выделения в списковой форме серверов, а также массовые рассылки в социальные сети (VKontakte, Facebook, Telegram) посредством автопостинга. Впервые в своем роде создается серая биржа на стыке интересов игровых серверов и партнеров входящих в состав проекта, что дает новые возможности рекламной площадки консолидировать в себе методы распространения информации.</span>
        </div>
