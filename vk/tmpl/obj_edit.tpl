<div id="edit_obj">
    <form class="obj_form" name="edit_obj" action="functions.php" method="post">
        %message%
        <ul id="obj_ul">
            <li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div id="area">
                            <div id="obj_area_1">
                                ...
                                <select name="obj_area_1" class="easydropdown" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="address">
                            ...
                            <input size="40" name="obj_address" id="obj_address" type="text"/>
                        </div>
                    </div>
                </div>
            </li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="upload.php/?type=obj" class="dropzone" id="my-dropzone">
...
<script>
    ...
    Dropzone.options.myDropzone = {
        ...
        removedfile: function(file) {
            ...
            $.ajax({
                type: 'POST',
                url: 'delete.php/?type=obj',
                data: "file="+name+"&objid="+id,
                dataType: 'html'
            });
            var _ref;
        ...
        init: function () {
            ...
            var id = $('#obj-id').val();
            <!-- 4 -->
            $.get('upload.php/?type=obj',{ objid: id})
                    .done( function (data) {
...
//                _point = new ymaps.Placemark([48.7979,44.7462], {
//                balloonContentBody: "Волгоград"});
