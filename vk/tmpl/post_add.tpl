<div id="create_obj">
    <form class="obj_form" name="post_add" action="functions.php" method="post">
        <ul id="obj_ul">
            <li>
            ...
            <li>
                <div class="row">
                    <div class="col-md-12">
                        <div id="mess">
                            <label for="desc">Содержимое статьи</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="short_desc">
                            ...
                            <textarea style="width: 100%" name="text_desc" id="short_desc" rows="5" cols="80"></textarea>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    <div class="col-md-12">
                        <p><b>Опции</b></p>
                        <div id="options">
                            <label><input id="mainpage" type="checkbox" value="1" name="post_mainpage" >На главную</label>
                            <input id="img_type" name="img_type" value="" hidden>
                        </div>
                    </div>
                </div>
            </li>
            <li id="li-for-main" hidden>
                <div class="row">
                    <div class="col-md-12">
            ...
            <li>
                <div class="submit">
                    <input class="submit" type="submit" name="post_create" value="Добавить">
                </div>
            </li>
        </ul>
    </form>
